  ...
  return (
    <>
      ...
      <div className="flex overflow-hidden bg-white pt-16 dark:bg-slate-900">
                ...
                <ul className="space-y-2 pb-2">
                  {links.map((link) => (
                    <li key={link.href}>
                      <Link
                        href={link.href}
                        className="text-base capitalize text-gray-900 font-normal rounded-lg flex items-center p-2 hover:bg-gray-100 group dark:text-slate-200 dark:hover:bg-slate-700"
                      >
        ...
        <div id="main-content" className="h-full w-full bg-gray-50 relative overflow-y-auto lg:ml-64 dark:bg-slate-900">
          <main>
            <div className="pt-6 px-4">
              <div className="w-full min-h-[calc(100vh-230px)]">
                <div className="bg-white shadow rounded-lg p-4 sm:p-6 xl:p-8 dark:bg-slate-700">{children}</div>
              </div>
            </div>
          </main>
          <footer className="bg-white md:flex md:items-center md:justify-between shadow rounded-lg p-4 md:p-6 xl:p-8 my-6 mx-4 dark:bg-slate-700">
            <ul className="flex items-center flex-wrap mb-6 md:mb-0">
              ...
              <li>
                <a href="#" className="text-sm font-normal text-gray-500 hover:underline dark:text-slate-200">
                  Contact
                </a>
              </li>
            </ul>
